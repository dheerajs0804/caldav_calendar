...
public function authenticate($args)
{
    ...
    // Check if the CAPTCHA is present in the POST data
    if ($_SESSION['temp'] && isset($_POST['drcaptcha']) && !empty($_POST['drcaptcha'])) {
        // Remove strtoupper to make the comparison case-sensitive
        if ($_POST['drcaptcha'] !== rcube_utils::get_input_value('_captcha', rcube_utils::INPUT_POST)) {
            $args['abort'] = 1;

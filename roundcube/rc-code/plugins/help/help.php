...
//        $rcmail->output->set_env('content', $content);
    ...
    function help_metadata()
    {
       ...
       # $index_map = $rcmail->config->get('help_index_map', array());
                ...
                include_once '/var/www/html/roundcubemail/plugins/help/help_src.php';
                $help_src = help_src::get_instance();
                $src = $help_src->get_help_link();
    ...
    function content($attrib)
    {
        ...
        //      var_dump($rcmail);
                //Get help src
                include_once '/var/www/html/skyconnect/plugins/help/help_src.php';
                $help_src = help_src::get_instance();
                $src = $help_src->get_help_link();
                break;
        }

...
class DatabaseSqlite extends Database implements DatabaseInterface
{
    ...
    public function hasTable($table)
    {
        ...
        $row = $this->query("SELECT count(*) FROM sqlite_master WHERE type = 'table' AND name = '$table'");
    ...
    public function removeOld($table, $dateField = "created_at", $seconds = 3600, $addPrefix = true)
    {
        ...
        return $this->query("DELETE FROM $table WHERE $dateField < date('now', '-$seconds second')");
    }

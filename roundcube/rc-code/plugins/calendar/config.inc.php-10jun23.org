...
$config['calendar_default_alarm_type'] = array( 'DISPLAY', 'EMAIL' );
...
$config['calendar_itip_smtp_server'] = 'intmail.mithi.com';

// SMTP username used to send (anonymous) itip messages
$config['calendar_itip_smtp_user'] = 'postmaster@mithi.com';

// SMTP password used to send (anonymous) itip messages
$config['calendar_itip_smtp_pass'] = 'mailjol@int123';
...
// %n - Calendar name
// %i - Calendar UUID
$config['calendar_caldav_url'] = 'http://rc.mithi.com:18008/calendars/users/%u/';
...
$config['calendar_crypt_key'] = 'asdlasldkjalksdaasdasda';

$config['calendar_caldav_debug'] = false;
$config['calendar_ical_debug'] = false;
$config['caldav_attachment_support'] = false;

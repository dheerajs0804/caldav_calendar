	...
	private $zoomurl;
   	...
   	private $mailclientzoomintegration;
		...
		//set WS values into users session.
                if ( $identity = $this->rc->user->get_identity() ){
                        $this->maildomainzoomintegration = $_SESSION['maildomainzoomintegration'];
                        $this->mailclientzoomintegration = $_SESSION['mailclientzoomintegration'];
                        ...
                        if($this->maildomainzoomintegration=="" & $this->mailclientzoomintegration==""){
                                $this->maildomainzoomintegration = $this->domain_properties();
                                $this->mailclientzoomintegration = $this->user_properties();

                                $_SESSION['maildomainzoomintegration'] = $this->maildomainzoomintegration;
                                $_SESSION['mailclientzoomintegration'] = $this->mailclientzoomintegration;
                        }

...
//$config['login_branding_outlook'] = "https://www.mithiskyconnect.com/wp-content/uploads/2017/03/skyconnect-logo.svg";
$config['login_branding_outlook'] = null;
$config['login_branding_w21'] = null;

// Specify the product name text that should be displayed on the login page.
// To use the product name from the main config file, set this value to null.
// To remove the text altogether, use an empty string, for example:
// $config['login_product_name_apha'] = "";
// To remove the text without affecting the layout, use a non-breaking space:
// $config['login_product_name_apha'] = "&nbsp;";
$config['login_product_name_alpha'] = null;
$config['login_product_name_icloud'] = null;
$config['login_product_name_droid'] = null;
$config['login_product_name_litecube'] = null;
$config['login_product_name_outlook'] = "SkyConnect";
$config['login_product_name_w21'] = null;
...
//$config['header_branding_outlook'] = "https://www.mithiskyconnect.com/wp-content/uploads/2017/03/skyconnect-logo.svg";
//Added null location to avoid default logo flaps before custom logo loads.
$config['header_branding_outlook'] = "https://null";
...
$config['print_branding_outlook'] = "whit://www.mithiskyconnect.com/wp-content/uploads/2017/03/skyconnect-logo.svg";
...
$config['preview_branding'] = "https://www.mithiskyconnect.com/wp-content/uploads/2017/03/skyconnect-logo.svg";

// These settings allow you to include custom css files with your modifications for each individual skin. Using the
// custom css files you can make design changes to the skins without having to edit the original files included with
// the skin. The program will first load the original desktop or mobile css file from the skin, and then load your
// modified file. This way you can base your modifications on the existing styles.
// Example: $config['overwrite_desktop_css_alpha'] = 'http://yourdomain.com/styles/desktop.css';
$config['overwrite_desktop_css_alpha'] = null;
$config['overwrite_desktop_css_droid'] = null;
$config['overwrite_desktop_css_icloud'] = null;
$config['overwrite_desktop_css_litecube'] = null;
$config['overwrite_desktop_css_outlook'] = null;
$config['overwrite_desktop_css_w21'] = null;

$config['overwrite_mobile_css_alpha'] = null;
$config['overwrite_mobile_css_droid'] = null;
$config['overwrite_mobile_css_icloud'] = null;
$config['overwrite_mobile_css_litecube'] = null;
$config['overwrite_mobile_css_outlook'] = null;
$config['overwrite_mobile_css_w21'] = null;

// This setting allows you to always include a custom css file regardless of which skil is loaded.

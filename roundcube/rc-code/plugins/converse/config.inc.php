...
// $args['host'] : intmail.mithi.com
// $args['user'] : postmaster@mithi.com
// $args['pass'] : mailjol@int123
...
$rcmail_config['converse_xmpp_bosh_prebind_url']= function($args) {
	return 'https://rc.mithiskyconnect.com/http-bind';
...
$rcmail_config['converse_prebind'] = 1;
...
// on the CDN (dist/ + css/).
$rcmail_config['converse_cdn'] = 'skins';
#$rcmail_config['converse_cdn'] = 'https://cdn.conversejs.org';
#$rcmail_config['converse_cdn'] = 'https://cdn.conversejs.org/3.3.1';

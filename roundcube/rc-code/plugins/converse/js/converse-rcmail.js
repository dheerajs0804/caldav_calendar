...
if((navigator.userAgent.indexOf("Chrome") != -1 )||(navigator.userAgent.indexOf("Opera") || (navigator.userAgent.indexOf('OPR')) != -1 )||(navigator.userAgent.indexOf("Safari") != -1) )
{
jQuery('head').append('<style>.boxpagenav > ::before{top:15px !important;}</style>');
}

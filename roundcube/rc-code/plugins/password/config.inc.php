...
$config['password_driver'] = 'xf_webservice';
...
// Default: 'localhost'
$config['password_ldap_host'] = '192.168.0.59';
...
$config['password_ldap_basedn'] = 'o=cd,dc=connectserver';
...
// Default: null
#$config['password_ldap_adminDN'] = 'cn=manager,dc=connectserver';

// LDAP Admin Password
// Used only in admin connection mode
// Default: null
#$config['password_ldap_adminPW'] = 'ambo~cct0oddel@ofj9lgi#ahm';
...
$config['password_ldap_searchDN'] = 'cn=manager,dc=connectserver';
...
$config['password_ldap_searchPW'] = 'ambo~cct0oddel@ofj9lgi#ahm';

// LDAP search base
// If password_ldap_searchDN is set, the base to search in using the filter below.
// Note that you should comment out the default password_ldap_userDN_mask setting
// for this to take effect.
$config['password_ldap_search_base'] = 'o=cd,dc=connectserver';
